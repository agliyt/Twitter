...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public UserAdapter(Context context, List<Tweet> tweets, onClickListener onClickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        user = Parcels.unwrap(((Activity) context).getIntent().getParcelableExtra(User.class.getSimpleName()));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            userScreenName = itemView.findViewById(R.id.username);
            userProfileImage = itemView.findViewById(R.id.profilePic);
            following = itemView.findViewById(R.id.following);
            followers = itemView.findViewById(R.id.followers);
            description = itemView.findViewById(R.id.description);
            profileLink = itemView.findViewById(R.id.link);
        ...
        public void bind(Tweet tweet) {
            ...
            following.setText(String.valueOf(user.following));
            followers.setText(String.valueOf(user.followers));
            description.setText(user.description);
            profileLink.setText(user.profileLink);
            Glide.with(context)
